...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]               LICENSY REYZXDZZ                   [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  ...
  if [ "$USER_TOKEN" = "reyzxdzz" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}PASSWORD SALAH${NC}"
    exit 1
  fi
  clear
}
...
if [ "$SELECT_THEME" -eq 1 ]; then
  ...
  echo -e "                                                                   "
    ...
    echo -e "${YELLOW}Masukkan link wa (https://wa.me/6288238792468) : ${NC}"
    read LINK_WA
    echo -e "${YELLOW}Masukkan link group (https://t.me/roomreyzxdzz) : ${NC}"
    read LINK_GROUP
    echo -e "${YELLOW}Masukkan link channel (https://t.me/roomreyzxdzz) : ${NC}"
    read LINK_CHNL
